...
public class ACT4_6_2_b_hojas {
    ...
    public static void main(String[] args) {
        ...
        // generar hojas y colocar en el tablero
        generarHojas(tablero, SIMBOLO_HOJA, NHOJAS);

        // * bucle que muestra la matriz , lee la acción y cambia la posición
        do {
            // aqui aún no funciona lo de generar las hojas porque en el bucle no verifico
            // que cuantas hojas hay
