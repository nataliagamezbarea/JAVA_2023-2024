...
public class ACT4_6_2_e_mostrarCaracteres {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            // UtilidadesMatrices.mostrarMatriz(tablero); Ponemos en lugar de mostrar matriz 
    ...
    // Recorre todo el tablero y si tablero [i] [j] al SÍMBOLO_GUSANO, hoja o vacio muestra el caracter
